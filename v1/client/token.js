...
const items = [
  { id: "grocery 1", price: 5 },
  { id: "grocery 2", price: 25 }
];
...
fetch("/create-payment-intent", {
  ...
  .then(function(data) {
    ...
    console.log("🚀 , file: token.js , line 27 , .then , clientSecret", clientSecret)
...
const createToken = (stripe,card) => {
  console.log("CREATE CARD TOKEN")
  loading(true)
  stripe.createToken(card).then((token)=>console.log(token))
